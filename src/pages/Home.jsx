...
const Home = () => {
    ...
    return (
        <div className="min-h-screen mt-14 md:mt-20">
            <section className="flex p-4 md:px-28 flex-col bg-no-repeat bg-[url('/hero.png')] w-full h-screen items-start justify-center =">
                ...
                <div className="flex  md:flex-row w-full items-center md:items-start gap-4 mt-10">
